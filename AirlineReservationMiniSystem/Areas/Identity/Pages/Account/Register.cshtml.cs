...
namespace AirlineReservationMiniSystem.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
		...
		public RegisterModel(
			...
			IEmailSender emailSender, IRoleRepository roleRepository)
		{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser {
                    ...
                    Role = _roleRepository.GetRoleById(Input.Role.Id.ToString()).Result
                };
                var result = await _userManager.CreateAsync(user, Input.Password);
                if (result.Succeeded)
                {
                     await _roleRepository.AddUserRole(user);
